...
class TestClient(object):
    ...
    def create_entities(self):
        ...
        self.ta_fed = self.federation_entity["https://ta.example.org"]
        self.rp_fed = self.federation_entity["https://rp.example.org"]["federation_entity"]
...
class TestServer():
    ...
    def test_entity_setup(self):
        ...
        assert set(self.leaf['federation_entity'].server.endpoint.keys()) == {'entity_configuration', 'fetch', 'list'}
    ...
    def test_entity_configuration(self):
        ...
        assert set(entity_configuration['metadata']['federation_entity'].keys()) == {
            'organization_name', 'homepage_uri', 'contacts', 'federation_fetch_endpoint',
...
class TestFunction:
    ...
    def create_entities(self):
        ...
        #         "homepage_uri": "https://ta1.example.org",
        #         "contacts": "operations@ta1.example.org"
        #     },
        #     key_config={"key_defs": KEYDEFS},
        #     endpoints=TA_ENDPOINTS
        # )
        ...
        #         "homepage_uri": "https://ta2.example.org",
        #         "contacts": "operations@ta2.example.org"
        #     },
        #     key_config={"key_defs": KEYDEFS},
        #     endpoints=TA_ENDPOINTS
        # )
