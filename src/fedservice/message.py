...
class AuthorizationServerMetadata(Message):
    ...
    c_param = {
        ...
        "token_auth_methods": SINGLE_OPTIONAL_JSON,
        "token_auth_signing_algs": SINGLE_OPTIONAL_JSON,
        ...
        "introspection_auth_methods": SINGLE_OPTIONAL_JSON,
        "introspection_auth_signing_algs": SINGLE_OPTIONAL_JSON,
