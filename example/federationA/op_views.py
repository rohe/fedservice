...
views = Blueprint('oidc_op', __name__, url_prefix='')
...
@views.route('/verify/user', methods=['GET', 'POST'])
def verify_user():
...
@views.route('/verify/user_pass_jinja', methods=['GET', 'POST'])
...
@views.route('/.well-known/<service>')
...
@views.route('/registration_api', methods=['GET'])
...
@views.route('/session', methods=['GET'])
...
@views.errorhandler(werkzeug.exceptions.BadRequest)
def handle_bad_request(e):
    return 'bad request!', 400


@views.route('/check_session_iframe', methods=['GET', 'POST'])
...
@views.route('/verify_logout', methods=['GET', 'POST'])
def verify_logout():
...
@views.route('/rp_logout', methods=['GET', 'POST'])
def rp_logout():
...
@views.route('/post_logout', methods=['GET'])
def post_logout():
